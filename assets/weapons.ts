...
export const rope = {
  ...
  result:
    "Nope, it wasn't the rope! The reason it had been moved was because the murderer had leant against it, feeling overwhelmed after the murder.",
};
export const chair2 = {
...
export const extinguisher = {
  ...
  summary:
    "Fire Extinguisher: Looks new, but the sticker underneath indicates it is very old and possibly unsafe. No dust, but there is a small dent. Inside the dent, the paint is chipping.",
  result:
    "Yes, you're absolutely right! The lack of dust is due to the murderer wiping it down with their sleeve, but some of the blood had already dried and wasn't obvious in the moment. It's a very old fire extinguisher, which has actually been put out by George in an act of pettiness towards the Captain.",
};
export const barrel = {
  initial: `The barrel is empty, and there is\nblood splashes on its front. However,\nthere is significantly less blood on\nthe barrel than on other items.`,
  closer: `There are several small dents on the\nmetal around the top, as well as a\nfew specks of rust. To be expected\nwhen it's on the top deck of a boat.`,
  under: `There is a darker circle under the\nbarrel, possibly protected from the\nsun, but it seems darker than the\nother circles. This looks like water\ndamage to the deck.`,
  summary:
    "Barrel: Empty, but looks like it was leaking water before. Several small dents and a few specks of rust at the top.",
  result:
    "There's literally no evidence that it's the barrel. How would someone be able to hit someone over the head with it. The only 'crime' the barrel has committed is being leaky.",
};
export const bell = {
  initial: `A rusted bell lays on the floor, the\ncaptain has told you that they use it\nto inform the staff of rougher waters.\nAssumingly so they can secure items\nsuch as plates and alcohol bottles\nso they don't smash.`,
  closer: `The bell still seems to work, despite\nthe copious amounts of rust. If someone\nhad used this to kill Tessa, they\nwould've alerted others.`,
  under: `There is absolutely nothing different\nabout the deck under the bell, indicating\nit had only just been placed there.\nHowever, on the deck, you spot several\nflakes of rust.`,
  summary:
    "Bell: Rusty, but still works. Has only just been placed there on the deck, but has been shedding small rust flakes.",
  result:
    "Nope, not the bell! It would've made too much noise. Olivia heard some clanging from the toilet, but that was just George messing with the pipes in an act of sabotage towards the Captain.",
};
