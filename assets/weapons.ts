...
export const extinguisher = {
  ...
  under:
    "Under the fire extunguisher, there is a safety log sticker. This shows all the times that this extunguisher has been checked to make sure it is fit for use. The last time it was checked was 18 months ago - the first time it was checked was 1999. Is this safe?",
};
export const barrel = {
  initial:
...
export const bell = {
  initial:
    "A slightly rusted bell lays on the floor, the captain has told you that they use it to inform the staff of rougher waters. Assumingly so they can secure items such as plates and alcohol bottles so they don't smash.",
  closer:
