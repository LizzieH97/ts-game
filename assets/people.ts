export const angela = {
  ...
  result: `Nope, it wasn't Angela! Her and Liam really were at the bar together. They had been sleeping together for five years, however. Angela was waiting for Liam to leave Tessa, and reminiscing at the bar was her last attempt.`,
};
export const george = {
  ...
  result: `Nope, it wasn't George! I mean he didn't even really have a motive, he was just salty about not becoming Captain. Wouldn't make sense for him to do it. Not to make you feel bad, but really you should. He has been putting faulty objects all over the ship as petty revenge, though.`,
};
export const liam = {
  ...
  result: `Nope, it wasn't Liam! He really was with Angela at the bar, but he had been cheating on Tessa with her for five years. He said he felt bad about breaking off the marriage, and had only proposed because Tessa was dropping hints. His only crime is not growing a pair.`,
};
export const olivia = {
